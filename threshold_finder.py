...
img = cv2.imread("cones_plus_barrel.jpg", cv2.CV_LOAD_IMAGE_COLOR)
"""
bounds = convertToChannelsAndPlotAndComputeBounds(img).getBounds()
print bounds

cv2.namedWindow('Filtered')
cv2.imshow('Filtered', runBoundedThreshold(img, bounds))
"""
cv2.namedWindow('Normal Image')
cv2.imshow('Normal Image', img)

cv2.namedWindow('Filtered')
cv2.imshow('Filtered', runBoundedThreshold(img, TWEAKED_BOUNDS))
